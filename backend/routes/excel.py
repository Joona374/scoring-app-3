...
from db.models import TeamStatsTag, User
...
async def get_teamstats_excel(db_session: Session = Depends(get_db_session), current_user_id: int = Depends(get_current_user_id)):
    ...
    #TODO This should only get the tags for the users team. Not sure if this wors
    ...
    team_stats_sheet = workbook.active

    for cell, value in cell_values.items():
        team_stats_sheet[cell] = int(value)
