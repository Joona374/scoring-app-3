...
def force_drop_tables():
    ...
    with engine.connect() as connection:
        ...
        connection.execute(text("DROP TABLE IF EXISTS users, teams, reg_codes, players, shot_results, shot_types, tags, games, games_in_roster, team_stats_tags, player_stats_tag_on_ice, player_stats_tag_participating CASCADE;"))
