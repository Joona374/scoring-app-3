...
export default function RollingAverageChart({ trendData, playerName, playerPosition }) {
  ...
  const positionLabel = playerPosition === "FORWARD" ? "Hyökkääjät" : "Puolustajat";

  const renderChart = (dataKey, teamDataKey, title, color, teamColor, label) => (
  ...
  return (
    <section className="rolling-avg-section">
      <div className="section-header-row info-row">
        ...
        <InfoTooltip text="Pelaajan ja hänen pelipaikkansa muiden pelaajien liukuva 5 ottelun keskiarvo. Auttaa hahmottamaan suoritustason kehitystä kauden aikana." />
      </div>
